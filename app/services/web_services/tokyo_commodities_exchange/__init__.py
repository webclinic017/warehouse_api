...
from .quotes_by_trade_date import quotes_by_trade_date_router
...
TOKYO_COMMODITIES_EXCHANGE_ROUTER_CONFIGS = [
    ...
    WebServiceRouterConfig(tag=__TOKYO_COMMODITIES_EXCHANGE_TAG, router=quotes_by_trade_date_router),
]
