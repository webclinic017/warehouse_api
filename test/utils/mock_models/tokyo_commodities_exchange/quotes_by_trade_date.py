"""
Database model from the quotes_by_trade_date table in the tokyo commodities exchange database
...
class QuotesByTradeDate(Base):
    """
    Database model for all quotes_by_trade_date supported by the nomics API from
    the /tokyo-commodities-historical/quotes-by-trade-date endpoint
    """
